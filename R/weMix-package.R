#' WeMix: a package to estimate weighted mixed-effects models. 
#' 
...
#' of mixed effects models with complex survey weights is not analytically calculable, so WeMix uses
...
#' 
#' This allows users to analyze data that may have unequal selection probably at both 
...
#' where there are weights at all levels of of the model,and is only indended for use with 
#' fully nested data. 
#' 
#' To start using WeMix, see the vignettes covering
#' the mathematical background of mixed-effects model estimation and use
