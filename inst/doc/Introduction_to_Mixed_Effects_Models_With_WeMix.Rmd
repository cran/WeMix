...
author: Developed by Paul Bailey, Claire Kelley, and Trang Nguyen \footnote{This publication
  ...
  this document, and Yuqi Liao, Bitnara Park, and Jiayi Li for their help with use of mixed models
...
The package \texttt{lme4} fits these models when there are no weights or weights only for first-level units (Bates, Maechler, Bolker, & Walker, 2015) and is recommended for those situations---by default, \texttt{WeMix} uses the \texttt{lme4} results as a starting point. \texttt{WeMix} adds the ability to fit models with weights at every level of the model. Linear models are fit using a modification  of the method used in \texttt{lme4} (Bates & Pinheiro, 1998; Bates et al., 2015). Non-linear models are fit with  a method similar to GLLAMM (Rabe-Hesketh, Skrondal, & Pickles, 2002; Rabe-Hesketh, Skrondal, & Pickles, 2005; Rabe-Hesketh & Skrondal, 2006) and for these models \texttt{WeMix} maximizes the same likelihood function as GLLAMM. Because the model applies weights at every level, the  units must be nested in "levels," so \texttt{WeMix} only fits models where the units have a nested structure.
...
\hline 
\rowcolor{header}
\multicolumn{7}{|c|}{\bf{Table 1: Results for Random Intercept Model } }\\
\hline 
\rowcolor{header}
& WeMix & Stata: MIXED & Stata: GLLAMM   & SAS & HLM$^1$  & M+ \\
\hline
...
\hline 
\rowcolor{header}
\multicolumn{7}{|c|}{\bf{Random Effects} }\\
\hline 
Var Random Intercept & 1413.81 & 1413.85 & 1413.83 & 1413.81 &  1020.05 &  1413.79  \\ 
Var Residual  & 5264.80 & 5264.80 & 5264.80 & 5264.80	 & 5061.13 & 5264.81  \\
\hline 
\rowcolor{header}
\multicolumn{7}{|c|}{\bf{Standard Error (SE) of Random Effects}} \\
SE Random Intercept & 263.46 & 340.75 & 365.91 & 	364.73 & 139.26 &  364.725 \\ 
SE Residual &  151.90 & 152.58 &  152.42  & 151.93 &  131.07 & 151.93 \\
\rowcolor{header}
\multicolumn{7}{|c|}{\bf{Fixed Effects}} \\
\hline 
(Intercept)    & 486.80 & 486.80 & 486.80 & 486.8 & 494.47 &  486.804  \\
st29q03: Agree        &  -11.108   & -11.108 & -11.108 & -11.108 & -24.119 & -11.109 \\
st29q03: Strongly disagree  & -41.542  & -41.542 & -41.542 & -41.5422	 & -54.788 & -41.543 \\
st29q03: Disagree  & -19.255  & -19.255  & -19.255 & -19.255		& -26.110 &    -19.256 \\
sc14q02: A lot      &    -26.913  &  -26.913 & -26.913  & -26.9126 & -24.504 & -26.912 	\\
sc14q02: To some extent & -11.782 & -11.782 & -11.782 & 	-11.7824 & -10.362 &   -11.782  	\\
sc14q02: Very little  &  -21.340  & -21.341 & -21.340 &  -21.340  & -19.506  & -21.341  \\
st04q01: Male       &     9.5077     &  9.5077  & 9.5077 & 9.5077		 & 12.164	&  9.508 \\
...
SE st29q03: Agree       & 5.6998 & 5.6998  & 5.6998 & 	5.6816 & 7.1401 & 5.682 \\
SE st29q03: Strongly disagree   & 6.8643 & 6.8643  & 6.8629 &	6.841 & 	12.108   & 6.841\\
SE st29q03: Disagree  & 5.4556  & 5.4556 &  5.4574 & 5.4400 & 	6.2607 &  5.440 \\
SE sc14q02: A lot    & 7.6573 & 7.6573 & 7.7959 & 7.7714 & 8.2081  &  7.772 \\
SE sc14q02: To some extent  & 12.821 & 12.821 & 13.000 & 12.958 & 13.587 & 12.958 \\
SE sc14q02: Very little   & 17.060 & 17.061 & 17.294 & 	17.239 & 15.286 & 17.239 \\
SE st04q01: Male        & 2.9860 & 2.9860 & 2.9850 & 2.9754 & 3.7008 & 2.975 \\
SE escs              & 2.1175 & 2.1175 & 2.1373 & 2.131 &  2.5250 & 2.130  \\
\hline
\multicolumn{7}{|l|}{$^1$ HLM requires that the weights are normalized before they are fit so results do not match exactly.} \\
\multicolumn{7}{|l|}{Also, HLM cannot set slope and intercept covariance to 0 (Raudenbush, Bryk, Cheong, Congdon, \& Toit, 2016).}\\
\hline
\end{tabular}
\end{table}
\clearpage
...
\hline
\rowcolor{header}
\multicolumn{7}{|c|}{\bf{Table 2: Results for Random Intercept and Slope Model} }\\
\hline 
\rowcolor{header}
& WeMix & Stata: MIXED & Stata: GLLAMM   & SAS & HLM$^1$  & M+ \\
\hline
Run Time & 0:36 & 00:30 & Fails to converge & 00:10 & 00:10 &  00:05\\
\hline 
...
\multicolumn{7}{|c|}{\bf{Random Effects} }\\
\hline 
Var of Intercept & 1354.71 & 1354.74 &  & 1354.71	&  984.87 &  1354.71  \\ 
Var of Slope of escs & 370.33 & 370.33 &  & 370.33 &  42.957 & 370.33  \\ 
Var of Residual  & 4967.36 & 4967.36 & & 4967.36		& 5010.3 & 4967.36     \\
\hline 
\rowcolor{header}
\multicolumn{7}{|c|}{\bf{Standard Error (SE) of Random Effects}} \\
SE Random Intercept & 287.88 & 296.97 &  & 311.72 & 137.65 &    311.73 \\ 
SE Slope of escs &  67.99  & 68.566 & & 66.325 &   48.378 &  66.324 \\
SE Residual  &  137.70  & 137.74 & & 137.36 &  132.48 &  137.36\\
\hline
\rowcolor{header}
\multicolumn{7}{|c|}{\bf{Fixed Effects}} \\
\hline 
(Intercept)    & 483.89 & 483.89 &  & 	483.89 & 494.03 & 483.89 \\
st29q03: Agree        &  -10.628   & -10.628 & & -10.628	 & -24.0123 &  -10.628  \\
st29q03: Strongly disagree  &   -38.708  & -38.708 &  & -38.7081& -54.471 & -38.708 \\
st29q03: Disagree  & -17.303 & -17.303 &  & -17.3031		& -25.909 &	 -17.303  \\
sc14q02: A lot      &   -39.941   &  -39.941  &   & -39.941		 &  -27.782 &  -39.941 \\
sc14q02: To some extent & -12.592    & -12.591  & & -12.592	& -11.048 &  -12.592 \\
sc14q02: Very little  &   -20.064  &  -20.064 &  & -20.0644	 & -19.513 & -20.064     \\
st04q01: Male       &    10.294    & 10.294   &    & 10.294 & 12.252 & 10.294  \\
escs             &      28.016   & 28.016 &  & 28.016 & 28.625 &  29.067 \\
\hline
\rowcolor{header}
\multicolumn{7}{|c|}{\bf{Standard Error of Fixed Effects}} \\
\hline 
SE (Intercept)    & 7.4055 & 7.4054 & & 7.4985 &  7.1488  &    7.499  \\
SE st29q03: Agree       & 5.4905 & 5.4905 & & 5.4737 & 	7.1236 &   5.474\\
SE st29q03: Strongly disagree   & 6.7682  & 6.7681 & & 	6.7593  & 	12.1794 &  6.759 \\
SE st29q03: Disagree  & 5.3723 & 5.3722 &  & 5.3572 & 6.2107  & 5.357 \\
SE sc14q02: A lot    & 7.2393  & 7.2393 & & 7.4109  & 7.3716 &   7.411  \\
SE sc14q02: To some extent  & 12.669 & 12.668 & & 	12.831 & 13.497  & 12.831 \\
SE sc14q02: Very little   & 15.583 & 15.583 &  & 15.5911 &  15.008 & 15.591  \\
SE st04q01: Male        & 3.0285 & 3.0285 &  & 3.0188 & 3.7084 & 3.709  \\
SE escs              & 2.5631 & 2.5631 &  & 	2.5341	 & 2.6105 & 3.019 \\
\hline
\multicolumn{7}{|l|}{$^1$ HLM requires that the weights are normalized before they are fit, so results do not match exactly.}\\
\multicolumn{7}{|l|}{Also, HLM cannot set slope and intercept covariance to 0 (Raudenbush, Bryk, Cheong, Congdon, \& Toit, 2016).} \\
\hline
...
## Mathematical Specification: Linear Models

Linear models are fitted with an analytic solution  similar to the one of Bates et al.,2015, details of can be found in the vignette \texttt{Weighted Linear Mixed-Effects Models}. 

## Mathematical Specification: Non-Linear Models

This section describes the mathematical methodology behind the estimation of non-linear Weighted Mixed models in \texttt{WeMix}.

The simplest version of this model has two levels and is of the form:
\begin{equation} \label{eq:basic}
\bm{y} = \bm{X\beta} + \bm{Z u}  + \bm{\epsilon} \ ,
\end{equation}
where $\bm{y}$ is the vector of outcomes, $\bm{X}$ is a matrix of covariates associated with regressors that are assumed to be fixed, $\bm{\beta}$ is the vector of fixed-effect regression coefficients, $\bm{Z}$ is a matrix of covariates associated with regressors that are assumed to be random, and $\bm{u}$ is the vector of random effects. The meaning of $\bm{u}$ being random is simply that a level is shared within a group and across groups $\bm{u} \sim MVN(\vec{\bm{0}},\bm{\Sigma})$, where $MVN(\cdot,\cdot)$ is the multivariate-normal distribution, $\vec{\bm{0}}$ is the mean vector of all zeros, and $\bm{\Sigma}$ is the covariance matrix of the multivariate-normal distribution.

## Hierarchical Linear Models Notation

The models \texttt{WeMix} fits can also be called hierarchical linear model (HLM; Raudenbush & Bryk, 2002) where the first level is of the form:
...
Note that \texttt{WeMix 3.0}  supports models with up to  three levels. Four or more level model fitting will be added to future versions.  
...
Table 3: & Notation \\ 
 \hline
$\bm{\theta}$ & vector of all of the model parameters fit, including $\bm{\beta}$ and the nonduplicated elements of the covariate matrices $\bm{\Sigma}^{(l)}$. Because they are integrated out, $\bm{u}$ is included in $\bm{\theta}$. \\
...
In the case of the normal distribution, the likelihood ($\mathcal{L}^{(1)}$) at the individual unit level is given by the equations below. Note that here the subscript $i$ is used to indicate that this is the likelihood of the $i^{th}$ individual. 
\begin{equation}
...
For ease of computation and in order to avoid problems with accurate storage of extremely small numbers we first take the log of the function before maximizing. Following Rabe-Hesketh & Skrondal (2006), eq. 1, the log-likelihood function is:
\begin{equation}
...
## Non-Linear Model Evaluation: Adaptive Gauss-Hermite Quadrature 

Unfortunately, in the non-linear case there is no closed-form expression for the integral in (10), and so we must evaluate the likelihood numerically. This is possible with  adaptive Gauss-Hermite quadrature, which is a modification of Gauss-Hermite quadrature.
...
For non-linear models, we use the transformation of variables described above, 
...
The variance estimator was calculated following the method of Rabe-Hesketh & Skrondal (2006). Thus, the variance is expressed:

\begin{equation}
var(\bm{u}) = \bm{I^{-1}J I^{-1}}
\end{equation}

where $\bm{I}$ is the pseudo Fisher information which is calculated by observing the Fisher  information at the maximum likelihood estimates. Given that the likelihood is twice differentiable, we estimate the Fisher information as the second derivative (Hessian) of the likelihood evaluated at the maximum likelihood point. 
\begin{equation}
\bm{I} =  \frac{ \partial^2 \mathcal{L}(\cdot) }{\partial \theta^2}
\end{equation}

and $\bm{J}$ is estimated as
\begin{equation}
...
Table 4 shows the output comparison between \texttt{WeMix} and STATA \texttt{GLLAMM}.

\definecolor{header}{rgb}{0.52,.44,1}
\begin{tabular}{|p{5cm}|r|r|} 
\hline 
\rowcolor{header}
\multicolumn{3}{|c|}{\bf{Table 4: Results for Binomial Model with Logit Link Function} }\\
\hline 
\rowcolor{header}
& WeMix & Stata: GLLAMM   \\
\hline 
...
For reference, these sections show the specification of the models in Stata's GLLAMM, Stata's MIXED, SAS PROC GLIMMIX, HLM, and M+.

## Stata: GLLAMM 

In Stata prior to version 14, weighted mixed-effects models could be estimated only with GLLAMM (Rabe-Heskteh, Skrondal, & Pickles, 2004). The work of GLLAMM authors Rabe-Hesketh, Skrondal, and Pickles provided the methods that we used in our implementation of non-linear weighted mixed models in \texttt{WeMix}. 
...
M+ is another common software used to fix mixed effects models. Note that you should make all  categorical variables into dummy variables prior to fitting the model. To fit the random intercept model use:  
...
To fit the random slope model use:  
...
Kreft, I. G., & de Leeuw, J. (1998). Introducing Statistical Methods: Introducing Multilevel Modeling. (London, UK) : *SAGE Publications Ltd.*
...
Scientific Software International. (2016). *Design weighting in the hierarchical context*. Retrieved March 23,2019 from https://www.ssicentral.biz/upload/hlmexample6-1.pdf
